...
class Transformation:
    ...
    def __init__(
        ...
        table_expiration: datetime = None,
        partition_expiration: datetime = None,
        ...
        :param table_expiration: Optional expiration date for the table generated by this transformation
        :type table_expiration: datetime
        :param partition_expiration: Optional expiration date for the partition used by the table generated by this transformation
        :type partition_expiration: datetime
